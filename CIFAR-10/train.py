...
from timm.models import create_model, safe_model_name, resume_checkpoint, load_checkpoint, model_parameters #  convert_splitbn_model
from timm.utils import *
from timm.loss import LabelSmoothingCrossEntropy, SoftTargetCrossEntropy, JsdCrossEntropy
from timm.optim import create_optimizer_v2, optimizer_kwargs
from timm.scheduler import create_scheduler
from timm.utils import ApexScaler, NativeScaler
from MHSANet_cifar10 import MHSANet29_32w_4s, MHSANet29_4x24w_4s
...
# Model detail
parser.add_argument('--model', default='MHSANet', type=str, metavar='MODEL',
                    help='Name of model to train (default: "countception"')
parser.add_argument('-T', '--time-step', type=int, default=1, metavar='time',
...
def main():
    ...
    model = MHSANet29_32w_4s(num_classes=10, T=args.time_step)
