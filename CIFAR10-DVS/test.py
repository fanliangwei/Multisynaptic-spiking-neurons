...
from MHSANet import MHSANet29_32w_4s
...
def parse_args():
    ...
    parser.add_argument('--model', default='snn_MHSANet29_32w_4s_mem_up_MSF-init_thre1.0-D4-surro(rectangular)', help='model')
    ...
    parser.add_argument('--resume', default='output/snn_MHSANet29_32w_4s_mem_up_MSF-init_thre1.0-D4-surro(rectangular)/checkpoint_max_test_acc1.pth', help='resume from checkpoint')
...
def main(args):
    ...
    model = MHSANet29_32w_4s(num_classes=10,T=args.T)
    ...
    if args.tb and utils.is_main_process():
        ...
        te_tb_writer = SummaryWriter(output_dir + '/logs/test', purge_step=purge_step_te)
