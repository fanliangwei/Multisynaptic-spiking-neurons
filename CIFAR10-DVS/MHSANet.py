...
class MHSANet(nn.Module):
    def __init__(
        ...
        self.maxpool1 = nn.MaxPool3d(kernel_size=(1,3,3),stride=(1,2,2),padding=(0,1,1))   ### timewindow>1时  multistep maxpool
        ...
        self.maxpool2 = nn.MaxPool3d(kernel_size=(1,3,3),stride=(1,2,2),padding=(0,1,1))   ### timewindow>1时  multistep maxpool
