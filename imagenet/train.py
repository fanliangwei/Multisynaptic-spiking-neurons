...
from MHSANet import MHSANet50_26w_4s, MHSANet101_26w_4s
try:
...
# Model detail
parser.add_argument('--model', default='MHSANet50_26w_4s_b128_8gpu_mem_up_MSF_surrogate(rectangular)t1_D4-224', type=str, metavar='MODEL',
...
def main():
    ...
    model = MHSANet50_26w_4s(num_classes=1000, T=1)
